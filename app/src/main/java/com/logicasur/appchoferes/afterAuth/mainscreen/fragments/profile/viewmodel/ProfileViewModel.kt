package com.logicasur.appchoferes.afterAuth.mainscreen.fragments.profile.viewmodel
...
import com.logicasur.appchoferes.data.network.signinResponse.Profile
...
class ProfileViewModel @Inject constructor(
    ...
    fun viewsForFragment(context: Context, binding: FragmentProfileBinding) {
        ...
        Log.d(TAG, " C DATE is  $currentDate")
    ...
    private fun logoutUser(action: () -> Unit) {
...
//                        authRepository.clearWholeDB()
    ...
    private fun getProfile() {
        ...
        viewModelScope.launch(Dispatchers.IO) {
            ...
            Log.d(TAG, "user personal data $profile")
    ...
    private fun updateAvatar(avatar: String, imageInBitmap: Bitmap, action: () -> Unit) {
    ...
    private fun updateProfileLocal(name: String, fatherName: String) {
        ...
        viewModelScope.launch(Dispatchers.IO) {
            ...
            val profileData = Profile(0, "", language?.toInt(), name, notify, fatherName)
