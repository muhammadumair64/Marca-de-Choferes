package com.logicasur.appchoferes.data.repository
...
import com.logicasur.appchoferes.data.network.SafeApiRequest
import com.logicasur.appchoferes.data.network.createNewPasswordResponse.CreateNewPasswordResponse
import com.logicasur.appchoferes.data.network.forgotPasswordResponse.ForgotPasswordResponse
import com.logicasur.appchoferes.data.network.getAvatarResponse.GetAvatarResponse
import com.logicasur.appchoferes.data.network.loadingResponse.LoadingResponse
import com.logicasur.appchoferes.data.network.loadingResponse.SplashResponse
...
class AuthRepository @Inject constructor(
    ...
    suspend fun clearUnsend(){
        localDataBase.unsentApiDao().apply {
            ...
            deleteAllUnsentStartBreakTime()
            deleteAllUnsentStartWorkTime()
    ...
    suspend fun CreateNewPasswordPassword(
        password: String,
        Token: String
